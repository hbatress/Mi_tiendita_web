      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 p-3 text-center">
        {products.map((product) => (
          <div 
            ...
            className="border-2 border-gray-200 p-3 rounded-md shadow-md hover:border-gray-300
          ...
          >
            ...
            <div className="rounded-tl-lg rounded-tr-lg bg-indigo-300 p-3 w-full futurista-text">
